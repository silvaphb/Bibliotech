...
from livraria.application.dtos import BookUpdateDTO
from livraria.api.dependencies import LivrariaContainer
from livraria.infrastruture.models import Book
from livraria.api.schemas import BookIn, BookOut, BookUpdate

from livraria.application.use_cases import RegisterBookUseCase, ReturnBookUseCase, DeleteBookUseCase, UpdateBookUseCase
from livraria.infrastruture.repository import BookRepository

api = Router()
container = LivrariaContainer()
...
@api.delete('/remover_livro', response={200: bool, 404: dict, 500: dict})
